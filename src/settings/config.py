...
# Dashboard Previews
IMG_PREVIEW_CLASSIFICATION = str(DEMOS_DIR / "image_classification_cifar10_display_preview.jpg")
...
IMG_PREVIEW_FACE_ANALYSIS = str(DEMOS_DIR / "face_analysis_display_example.png")
