...
while True:
    ...
    if len(todas_maos) == 1:
        ...
        if todas_maos[0]['lado'] == 'Right':
            if info_dedos_mao1 == [False, True, False, False, False] and word_app == False:
                word_app = True
                os.startfile(r'C:\Program Files\Microsoft Office\root\Office16\WINWORD.EXE')
            if info_dedos_mao1 == [False, True, True, False, False] and excel_app == False:
                excel_app = True
                os.startfile(r'C:\Program Files\Microsoft Office\root\Office16\EXCEL.EXE')
            if info_dedos_mao1 == [False, True, True, True, False] and firefox_app == False:
                firefox_app = True
                os.startfile(r'C:\Program Files\Mozilla Firefox\firefox.exe')
            if info_dedos_mao1 == [False, False, False, False, False] and firefox_app == True:
                firefox_app = False
